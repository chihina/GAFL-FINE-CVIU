...
cfg.query_dir = os.path.join('data_local', 'basketball_query')
...
# model_name = '[BSK_GAFL_PAF_mask_6_hbb_vgg_0.0001_wo_TB_15_6_stage2]<2025-04-28_03-53-32>'
# model_name = '[BSK_GAFL_PAF_PPF_mask_6_hbb_vgg_0.0001_wo_TB_15_6_stage2]<2025-04-28_03-57-43>'
# model_name = '[BSK_GAFL_PPF_mask_6_hbb_vgg_0.0001_w_TB_15_6_stage2]<2025-04-28_03-55-02>'
model_name = '[BSK_GAFL_PPF_JAE_mask_6_hbb_whole_vgg_0.0001_w_TB_15_6_stage2]<2025-04-28_04-02-11>'
...
if mode == 'PAC':
    ...
    # cfg.train_backbone = True
    cfg.load_backbone_stage2 = False
    cfg.use_activity_loss = True
    cfg.max_epoch = 3000
    cfg.batch_size = 8
    cfg.use_ind_feat_crop = 'roi_multi'
    cfg.num_activities = 9
...
cfg.nba_track_dir = os.path.join('data_local', 'NBA_dataset', 'tracks_deep_eiou')
cfg.num_frames = 6
# cfg.num_frames = 12
# cfg.nba_track_step = 4
# cfg.num_frames = 72 // cfg.nba_track_step
cfg.random_sampling = False
cfg.nba_ball_track_dir = os.path.join('data_local', 'NBA_dataset', 'wasb')
...
cfg.exp_note = f'BSK_GAFL_{mode}_mask_{mk_num}_{cfg.use_grp_feat}_{cfg.use_app_feat_type}'
cfg.exp_note += f'_{cfg.train_learning_rate}_{cfg.num_boxes}_{cfg.num_frames}'
...
wandb.login()
wandb.init(project=f"DIN-Group-Activity-Recognition-Benchmark-Basketball",
