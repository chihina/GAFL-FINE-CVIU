...
cfg.nba_track_dir = os.path.join('data_local', 'NBA_dataset', 'tracks_deep_eiou_prune_18')
...
# cfg.exp_note = 'BSK GR prev ImageNet pretrain VGG crop'

# cfg.inference_module_name = 'group_relation_ae_volleyball'
# cfg.exp_note = 'BSK GR prev ImageNet pretrain autoencoder crop'

cfg.inference_module_name = 'group_relation_hrn_volleyball'
# cfg.exp_note = 'BSK GR prev ImageNet pretrain HRN crop'
cfg.exp_note = f'BSK GR prev ImageNet pretrain HRN crop {cfg.num_frames}frames'
