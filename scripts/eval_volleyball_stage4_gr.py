...
# model_exp_name_list = glob.glob(os.path.join('result', '*VOL_GAFL_PAC*'))
# model_exp_name_list = glob.glob(os.path.join('result', '*VOL_GAFL_PAC*spike*'))
# model_exp_name_list = glob.glob(os.path.join('result', '*VOL_GAFL_PAC*pass*'))
# model_exp_name_list = glob.glob(os.path.join('result', '*VOL_GAFL_PAC*set*'))
# model_exp_name_list = glob.glob(os.path.join('result', '*VOL_GAFL_PAC*winpoint*'))
