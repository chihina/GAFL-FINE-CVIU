...
cfg.model_exp_name = 'train_collective_stage4'
...
if cfg.mode == 'PAC':
    ...
    cfg.batch_size = 16
    mk_num = 6
elif cfg.mode == 'PAF_RP':
    cfg.train_backbone = False
    cfg.use_pos_type = 'relative_vid'
    cfg.batch_size = 16
elif cfg.mode == 'PAF_RPIMG':
    cfg.train_backbone = False
    cfg.use_pos_type = 'relative_img'
    cfg.batch_size = 16
...
cfg.exp_note = f'CAD_GAFL_{cfg.mode}'
