...
model_exp_name_stage2_array=(
  ...
  '[VOL_GAFL_PPF_JAE_mask_6_hbb_whole_vgg_wo_TB_JAE_pred_stage2]<2025-05-05_20-57-35>'
)
...
sampling_mode_array=(
  ...
  # 'kmeans_gaf'
  # 'kmeans_form'
  # 'kmeans_gaf_innorm_form'
  # 'kmeans_gaf_form_innorm'
  # 'kmeans_gaf_innorm_form_innorm'
  # 'coreset_gaf_innorm_form_innorm'
  # 'earan'
)
                                                              ...
                                                              for sampling_mode in ${sampling_mode_array[@]}; do
                                                                for metric_lr_margin in ${metric_lr_margin_array[@]}; do
                                                                  for load_backbone_stage4 in ${load_backbone_stage4_array[@]}; do
                                                                    ...
                                                                    python scripts/train_eval_volleyball_stage4.py -gpu $gpu -query $query -max_epoch $max_epoch \
